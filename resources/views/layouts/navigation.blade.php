...
<nav x-data="{ open: false }" class="bg-white shadow-sm">
        ...
        <div class="hidden md:flex items-center gap-4">
            ...
            @else
                <a href="#" onclick="toggleModal('loginModal')"
                    ...
                    🛒
                    <span
                        class="absolute -top-1 -right-1 bg-gray-400 text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center">
                        0
                    </span>
                </a>
            @endauth
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="md:hidden border-t border-gray-200">
        <div class="px-4 pt-3 pb-4 space-y-3">
            ...
            @else
                <a href="#" onclick="toggleModal('loginModal')"
                    class="flex items-center justify-between border border-gray-300 rounded-md px-3 py-2 text-gray-500 hover:bg-gray-50">
                    <span>🛒 My Cart</span>
                    <span class="bg-gray-400 text-white text-xs rounded-full px-2 py-0.5 font-semibold">0</span>
                </a>
            @endauth
